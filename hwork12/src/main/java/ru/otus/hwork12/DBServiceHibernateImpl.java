...
import ru.otus.hwork12.cache.MyCache;
import ru.otus.hwork12.cache.MyCacheMBean;
...
public class DBServiceHibernateImpl implements DBService {
    ...
    private void RegMyCachMBean(MyCacheMBean<Integer, DataSet> myCache) {
        ...
        try {
            mBeanServer.registerMBean(myCache, new ObjectName("ru.otus.hwork12.MyCache:type=MyCache"));
